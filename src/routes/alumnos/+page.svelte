...
<article class="contenedor-general">
  <h2>Testimonios de alumnas que pasaron por mis clases</h2>
  <Carrusel tipo="imagen" items={testimonios}/>
</article>
...
<article class="contenedor-general">
  <h2>Juntas somos mas fuertes</h2>
  <Carrusel tipo="imagen" items={grupales}/>
</article>